...
export default function EventsPage() {
  ...
  // Debounce ref so we don't log every keystroke
  ...
  const fetchEvents = useCallback(async () => {
    ...
    // Debounce search logging by 1.5 seconds after filters settle
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500" aria-live="polite" aria-atomic="true">
            {loading
              ? 'Loading...'
